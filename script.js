         ...
         // сортування стовбців, 
	initial_sort_id = 0; // номер початкового відсортованого стовбця, починаючи з нуля
	initial_sort_up = 1; // 0 - сортування вниз, 1 - вверх
	var sort_case_sensitive = false; // чутливість до регістру при сортуванні
	...
	function init(e) {
		...
		for (var j = 0; (thead = document.getElementsByTagName("thead").item(j)); j++) {
			...
			for (var i = 0; (node = thead.getElementsByTagName("td").item(i)); i++) {
				...
				node.title = "Натисніть на заголовок, щоб відсортувати колонку";
			}
